...
async function loadJSON(path = 'ai_analysis.json') {
  // Evita cache agressivo do CDN/Amplify
...
function applyData(json) {
  ...
  setKPI('kpi-cross-rate', (sum.cross_events_rate ?? 0) * 100, 3); // em %
